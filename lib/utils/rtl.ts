 ...
 */
export const getRowDirection = (): 'row' | 'row-reverse' => (I18nManager.isRTL ? 'row-reverse' : 'row');

/**
 * Get flex direction based on RTL setting
 */
export const getFlexStart = (): 'flex-start' | 'flex-end' => (I18nManager.isRTL ? 'flex-end' : 'flex-start');

/**
 * Get flex end based on RTL setting
 */
export const getFlexEnd = (): 'flex-start' | 'flex-end' => (I18nManager.isRTL ? 'flex-start' : 'flex-end');
