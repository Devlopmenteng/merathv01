...
export const Results = ({ navigation }: { navigation: any }) => {
  ...
  useEffect(() => {
    ...
    incrementCalculationCount().catch((_err: unknown) => {
      // Usage stats are non-critical; swallow but acknowledge
    });
    if (!savedRef.current) {
      ...
      saveAuditTrail({
        ...
        Alert.alert('تنبيه', 'تعذر حفظ سجل الحساب. النتائج لا تزال صحيحة.');
      });
    }
  ...
  const copyAsText = async () => {
    ...
    try {
      ...
      Alert.alert('\u062e\u0637\u0623', '\u062a\u0639\u0630\u0631 \u0646\u0633\u062e \u0627\u0644\u0646\u062a\u0627\u0626\u062c.');
    }
  };
