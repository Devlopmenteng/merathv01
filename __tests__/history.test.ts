...
describe('History Storage', () => {
  it('saves and retrieves history', async () => {
    ...
    await AsyncStorage.setItem(APP_DEFAULTS.STORAGE_KEYS.HISTORY, JSON.stringify([entry]));
    const stored = await AsyncStorage.getItem(APP_DEFAULTS.STORAGE_KEYS.HISTORY);
